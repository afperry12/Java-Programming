...
//     char delimiter = ',';
//     RecordReader recordReader = new CSVRecordReader(numLinesToSkip, delimiter);
//     recordReader.initialize(new FileSplit(new ClassPathResource("BlackjackData.csv").getFile()));
...
//                                 .addColumnCategorical("result", Arrays.asList("lose", "win", "push", "blackjackwin"))
//                                 .build();

//                 final TransformProcess transformProcess = new TransformProcess.Builder(schema)
//                                 .categoricalToInteger("result")
//                                 .build();
...
//                                 "C:\\Users\\arthu\\Desktop\\CS112-afperry12\\Project01\\BlackjackAI\\demo\\src\\main\\resources\\BlackjackModel.zip"); // Where
//                                                                                                                                                                 // to
//                                                                                                                                                                 // save
//                 // the network.
//                 // Note: the file
