...
public class WordSearch {
	...
	static boolean SearchBwd(char[][] puzzle, String word) {
		...
		// Hint:  don't reverse the puzzle.
		// Reverse 'word' and then call SearchFwd() .
	}
	...
	static boolean SearchUp(char[][] puzzle, String word) {
		...
		// Once you finish SearchUp, you can approach SearchDown()
		// the same way as you handled SearchBwd() .
	}
